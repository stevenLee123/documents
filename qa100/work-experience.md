...
jwt的数据量较大，我们这边有些用户的权限资源信息会比较多，传输起来可能会有一定的负载
  ...
  工作中的亮点，难点： 
  1. 对spring security的学习，整合oauth2.0协议，提供rms-sdk的客户端包
  2. 新封装一套基础的jar包，解决之前同事提供的jar包中各种版本冲突导致的各种问题 
   3. 对配置中心的选择和搭建，考虑到项目中的实际需求以及需求，选择apollo作为配置中心，一是因为apollo的配置中心支持权限控制，二是各个项目的控制就是以项目来进行划分，比较清晰，同时也可以在各个项目配置中划分namespace，按照namespace来进行权限控制，三是在项目中使用起来比较简单
   4. 业务上的创新，针对业务部门运营同事不会编写sql的
...
1. 自我介绍 --介绍工作经历、项目经历（将项目经历的主次分清楚，明确自己主要做了哪些工作，解决了哪些问题，达到了什么效果）
...
自我介绍：
18年研究生毕业
进入中控信息做交通信号系统的研发，主要功能是针对路口的信号机、红绿灯设备、视频设备等进行控制，同时对路段、整体区域的交通拥堵状况进行全局管控
参与了从V4桌面端应用到V5 web端应用的演进，主要实现了特勤线路的功能，针对重大事件如马拉松、重要领导人到访时、救护车路线某一特定线路的交通管控功能，目前中控的交通控制信号系统应该还在杭州及周边城市的交警大队使用

21年进入丁香园大数据部门，在这边主导了从0-1使用spring security + oauth2.0实现了数据访问权限控制系统rms，参与数据中台web端的建设，参与日志打点分析平台的建设，实现面向公司非技术人员在web页面访问数据及精细化的权限管控，提升业务访问数据的实时性。现在丁香园大数据中台已经比较稳定，主要是一些偏维护的工作，我想换一个环境
